      ...
      <div className="min-h-screen flex items-center justify-center bg-gray-950 px-4">
        <div className="max-w-md w-full text-center">
          <div className="bg-gray-800 p-8 rounded-lg border border-gray-700">
            ...
            <p className="text-gray-300 mb-4">Signing you in...</p>
        ...
        <div className="bg-gray-800 p-8 rounded-lg border border-gray-700 space-y-6">
          ...
          <div className="space-y-4">
            <button
              ...
              className="w-full flex items-center justify-center px-4 py-3 bg-white text-gray-900 rounded-md shadow-sm hover:bg-gray-50 transition-colors font-medium border"
            >
            ...
            <p className="text-center text-sm text-gray-400">
              Quick and secure account creation with Google
            </p>
          </div>
          ...
          <div className="relative">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="px-4 bg-gray-800 text-gray-400">Or create account with email</span>
            </div>
          </div>
