      ...
      <div className="max-w-md w-full space-y-8">
        ...
        <div className="bg-gray-800 p-8 rounded-lg border border-gray-700 space-y-6">
          ...
          <button
            ...
            className="w-full flex items-center justify-center px-4 py-2 border border-gray-600 rounded-md shadow-sm text-white bg-gray-700 hover:bg-gray-600 transition-colors"
          >
